...
void items_init(Item *items){
    items[0].id=ITEM_PAPER;  items[0].pos.r=14; items[0].pos.c=5;  items[0].collected=false;
    items[1].id=ITEM_KEY;    items[1].pos.r=3;  items[1].pos.c=28; items[1].collected=false;
    items[2].id=ITEM_CANDLE; items[2].pos.r=15; items[2].pos.c=12; items[2].collected=false;
    items[3].id=ITEM_PHONE;  items[3].pos.r=14; items[3].pos.c=30; items[3].collected=false;
