...
static void get_room_bounds(int room,int *r1,int *c1,int *r2,int *c2){
    if(room==1){*r1=0;  *c1=0;  *r2=9;      *c2=19;}
    else if(room==2){*r1=0;  *c1=20; *r2=9;      *c2=39;}
    else if(room==3){*r1=10; *c1=0;  *r2=19;     *c2=19;}
    else if(room==4){*r1=10; *c1=20; *r2=19;     *c2=39;}
    else if(room==5){*r1=20; *c1=0;  *r2=ROWS-1; *c2=19;}
    else            {*r1=20; *c1=20; *r2=ROWS-1; *c2=39;}
}
